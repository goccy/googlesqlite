...
upstream_url: https://github.com/google/googlesql/blob/master/docs/pipe-syntax.md#as_pipe_operator
last_synced: 2026-05-12
testdata: testdata/specs/googlesql/syntax/pipe/as.yaml
---
...
Names the preceding pipe step's table. Subsequent pipe operators can
qualify columns through that name.
