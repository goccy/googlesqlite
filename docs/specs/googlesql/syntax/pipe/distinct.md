...
upstream_url: https://github.com/google/googlesql/blob/master/docs/pipe-syntax.md#distinct_pipe_operator
last_synced: 2026-05-12
testdata: testdata/specs/googlesql/syntax/pipe/distinct.yaml
---
...
Removes duplicate rows from the preceding pipe step.
