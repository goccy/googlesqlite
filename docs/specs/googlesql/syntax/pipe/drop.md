...
upstream_url: https://github.com/google/googlesql/blob/master/docs/pipe-syntax.md#drop_pipe_operator
last_synced: 2026-05-12
testdata: testdata/specs/googlesql/syntax/pipe/drop.yaml
---
...
Removes the named columns from the table produced by the preceding pipe
step.
