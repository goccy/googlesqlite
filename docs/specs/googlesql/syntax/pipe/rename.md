...
upstream_url: https://github.com/google/googlesql/blob/master/docs/pipe-syntax.md#rename_pipe_operator
last_synced: 2026-05-12
testdata: testdata/specs/googlesql/syntax/pipe/rename.yaml
---
...
Renames one or more columns in the table produced by the preceding pipe
step. Column ordering is preserved.
