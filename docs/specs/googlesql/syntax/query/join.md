...
testdata: testdata/specs/googlesql/syntax/query/join.yaml
---
...
INNER / LEFT / RIGHT / FULL OUTER / CROSS join variants between two table expressions, with `ON` predicate or `USING (cols)` clause.
