...
upstream_url: https://github.com/google/googlesql/blob/master/docs/query-syntax.md#pivot_operator
last_synced: 2026-05-12
testdata: testdata/specs/googlesql/syntax/query/pivot.yaml
---
...
`PIVOT` rotates rows into columns. One column per literal value in the
`IN (...)` list, one aggregate expression per pivot.
