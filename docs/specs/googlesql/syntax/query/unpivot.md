...
upstream_url: https://github.com/google/googlesql/blob/master/docs/query-syntax.md#unpivot_operator
last_synced: 2026-05-12
testdata: testdata/specs/googlesql/syntax/query/unpivot.yaml
---
...
`UNPIVOT` rotates one or more columns into rows, producing a value
column and a column-name column.
