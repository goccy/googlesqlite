...
upstream_url: https://github.com/google/googlesql/blob/master/docs/query-syntax.md
last_synced: 2026-05-12
testdata: testdata/specs/googlesql/syntax/query/intersect.yaml
---
...
Keeps rows that appear in both inputs. `INTERSECT DISTINCT` deduplicates; `INTERSECT ALL` retains the per-row minimum.
