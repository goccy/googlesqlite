...
testdata: testdata/specs/googlesql/syntax/script/return.yaml
---
...
Exit the current procedure or script early. No return value is supported in BigQuery scripting.
