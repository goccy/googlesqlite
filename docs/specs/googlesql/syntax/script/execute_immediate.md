...
testdata: testdata/specs/googlesql/syntax/script/execute_immediate.yaml
---
...
`EXECUTE IMMEDIATE sql_string` re-parses and runs a dynamically-built SQL string. Accepted but unevaluated for now.
