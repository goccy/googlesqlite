...
testdata: testdata/specs/googlesql/syntax/script/raise.yaml
---
...
Raises a user-defined error: `RAISE USING MESSAGE = 'reason'` or just `RAISE` inside an exception handler to re-raise.
