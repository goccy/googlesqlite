...
testdata: testdata/specs/googlesql/syntax/script/assert.yaml
---
...
`ASSERT predicate [AS 'msg']` evaluates the predicate at execution time; in BigQuery a false predicate aborts the script with the message. googlesqlite parses the statement; runtime evaluation is left to a future revision.
