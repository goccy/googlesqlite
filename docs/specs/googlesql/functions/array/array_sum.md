...
upstream_url: https://github.com/google/googlesql/blob/master/docs/array_functions.md#array_sum
last_synced: 2026-05-04
testdata: testdata/specs/googlesql/functions/array/array_sum.yaml
---
