...
status: implemented
notes: |
  Builds a POLYGON from an outer LINESTRING (plus optional inner hole LINESTRINGs). Runtime entry: BindStMakePolygon in internal/functions/geography/.
source_url: docs/third_party/googlesql-docs/geography_functions.md
upstream_url: https://github.com/google/googlesql/blob/master/docs/geography_functions.md#st_makepolygon
last_synced: 2026-05-04
testdata: testdata/specs/googlesql/functions/geography/st_makepolygon.yaml
---
