...
status: implemented
notes: |
  Monotone-chain convex hull of every vertex of the input. Runtime entry: BindStConvexHull in internal/functions/geography/.
source_url: docs/third_party/googlesql-docs/geography_functions.md
upstream_url: https://github.com/google/googlesql/blob/master/docs/geography_functions.md#st_convexhull
last_synced: 2026-05-04
testdata: testdata/specs/googlesql/functions/geography/st_convexhull.yaml
---
