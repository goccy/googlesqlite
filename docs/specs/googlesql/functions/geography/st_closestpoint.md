...
status: implemented
notes: |
  Returns the vertex of `a` geodesically closest to any vertex of `b`. Runtime entry: BindStClosestPoint in internal/functions/geography/.
source_url: docs/third_party/googlesql-docs/geography_functions.md
upstream_url: https://github.com/google/googlesql/blob/master/docs/geography_functions.md#st_closestpoint
last_synced: 2026-05-04
testdata: testdata/specs/googlesql/functions/geography/st_closestpoint.yaml
---
